  ...
  return (
    <section className='left_sidebar'>
        ...
        <Link href="/" className="flex cursor-pointer items-center gap-1 pb-10 max-lg:justify-center">
          <Image src="/icons/logos.svg" alt="logo" width={23} height={27} />
          <h1 className="text-18 font-extrabold text-white max-lg:hidden">PodPulse</h1>
        </Link> 
      ...
      <SignedIn>
        <div className="flex-center w-full pb-14 max-lg:px-4 lg:pr-8">
          <Button className="text-16 text-black-1 w-full bg-red-1 font-extrabold" onClick={() => signOut(() => router.push('/'))}>
            Log Out
          </Button>
        </div>
      </SignedIn>
