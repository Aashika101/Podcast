...
const CreatePodcast = () => {
  ...
  return (
    <section className="mt-10 flex flex-col">
      ...
      className="mt-12 flex w-full flex-col space-y-8">

        <div className="flex flex-col gap-[30px] border-b 
        ...
        <div className="flex flex-col gap-2.5">
          <Label className="text-18 font-bold text-white-1">
            Select AI voice
          </Label>
        ...
        <div className="flex flex-col pt-5">
          ...
          setCorrectedText={setCorrectedText} // Pass setCorrectedText
          handleCorrectText={() => Promise.resolve()} 
          ...
          <div className="mt-10 w-full">
            <Button type="submit" 
            className="text-16 w-full bg-red-1 py-4 font-extrabold text-black-1 transition-all
